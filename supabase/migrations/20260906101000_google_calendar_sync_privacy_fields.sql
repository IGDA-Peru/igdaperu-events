-- Reencola cambios en enlaces de inscripción y precisión/alcance de ubicación.
  ...
  if tg_op = 'DELETE' then
    ...
    if tg_op = 'INSERT' then
      ...
      changed_fields := (
        ...
        or old.location_precision is distinct from new.location_precision
        or old.location_department is distinct from new.location_department
        or old.location_province is distinct from new.location_province
