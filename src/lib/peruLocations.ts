export const peruLocations = {
  ...
  Callao: ['Callao'],
  Cusco: ['Acomayo', 'Anta', 'Calca', 'Canchis', 'Chumbivilcas', 'Cusco', 'Espinar', 'La Convención', 'Paruro', 'Paucartambo', 'Quispicanchi', 'Urubamba'],
...
export type PeruDepartment = keyof typeof peruLocations
export const peruDepartments = Object.keys(peruLocations) as PeruDepartment[]
